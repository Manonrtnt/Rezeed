...
--
-- Host: localhost
-- Generation Time: Jan 27, 2022 at 02:29 PM
...
(10, 'root', 'root', 'root', 'dc76e9f0c0006e8f919e0c515c66dbba3982f785', 'test@co.co', 'classique');
...
ALTER TABLE `customize`
  ...
  ADD CONSTRAINT `fk_user_customize` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`);
...
ALTER TABLE `playlist`
  ...
  ADD CONSTRAINT `fk_user_playlist` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`);
COMMIT;
